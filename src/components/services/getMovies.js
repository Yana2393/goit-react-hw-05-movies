...
//     try {
//         const response = await axios.get(`https://api.themoviedb.org/3/movie/movie_id/credits?api_key=${API_KEY}&language=en-US`);
//         return response.data;
//     } catch (err) {
//         console.log(err);
//         return err;
...
//     try {
//         const response = await axios.get(`https://api.themoviedb.org/3/movie/movie_id/reviews?api_key=${API_KEY}&language=en-US`);
//         return response.data;
//     } catch (err) {
//         console.log(err);
//         return err;
